...
export class APIBoards {
	...
	public getPersonalBoards(input: PersonalFunctionsInput['getPersonalBoards']) { return this.web.personal.getPersonalBoards(input); }
	/** @deprecated Use manager.personal for personal-board endpoints. */
	public createPersonalBoard(input: PersonalFunctionsInput['createPersonalBoard']) { return this.web.personal.createPersonalBoard(input); }
	/** @deprecated Use manager.personal for personal-board endpoints. */
	public createPersonalCategory(input: PersonalFunctionsInput['createPersonalCategory']) { return this.web.personal.createPersonalCategory(input); }
